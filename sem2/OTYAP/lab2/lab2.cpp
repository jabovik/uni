...
enum Signals{ALPHABETIC, DELIM, UNIDENTIFIED};
enum States {S_BEGIN, S_OOR, S_POTENTIAL_FAIL, S_FAIL, S_PUSH, S_POP, S_GOOD, S_REPUSH, S_DOUBLE_PUSH, S_DOUBLE_PUSH2};
...
std::vector<char*> compile(char* text)
{
    ...
    while(*text)
    {
        ...
        do
        {
            ...
            switch(table_select)
            {
                case 0: create_table2(table); break;
                case 1: create_table3(table); break;
                case 2: create_table4(table); break;
